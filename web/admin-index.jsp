...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- Manage Shelter Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="admin-shelters.jsp">
      ...
      <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Shelters <span>| Today</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Victims <span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Volunteers <span>| This Year</span></h5>
          ...
          <div class="row">
                  ...
                  <script>
                    document.addEventListener("DOMContentLoaded", () => {
                      new ApexCharts(document.querySelector("#reportsChart"), {
                        series: [{
                          name: 'Shelters',
                          data: [31, 40, 28, 51, 42, 75, 56],
                        }, {
                          name: 'Victims',
                          data: [11, 32, 50, 32, 34, 52, 41]
                        }, {
                          name: 'Volunteers',
                          data: [15, 25, 32, 18, 9, 24, 11]
                        }],
                        chart: {
                          height: 350,
                          type: 'area',
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Needs <span>| Today</span></h5>
        ...
        <div class="col-lg-5">
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Menolong mangsa banjir di Besut kelantan.
                  </div>
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Mengumpul pakaian terpakai untuk mangsa-mangsa banjir.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Pertubuhan kumpulan sukarelawan yang baru.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Menyelamatkan mangsa di Sungai Petani, Kedah.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Penerimaan sumbangan daripada rakyat Malaysia.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Ceramah keselamatan semasa banjir di SMK Dusun Nanding, Hulu Langat, Selangor.
                  </div>
                </div><!-- End activity item-->
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Needs Budget Report <span>| This Month</span></h5>
