    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Request Need</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Request Need</h5>
              <form class="row g-3" method="POST" action="AdminNeedAddServlet">
                <div class="col-md-12">
                <% 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display: flex; flex-direction: column; align-items: center; gap: 5px;">
                                                            <div class="filter">
                                                                    <button type="button" onclick="window.location.href='admin-needAdd.jsp?ShelterID=<%= shelter.getShelterID() %>'" class="btn btn-warning rounded-pill btn-sm ri-add-circle-line"></button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                ...
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="item" name="NEED_ITEM" placeholder="Item" required>
