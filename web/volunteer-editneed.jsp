        ...
        <div class="col-lg-10 offset-lg-1">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="VolunteerNeedEditServlet">
                <input type="hidden" name="needID" value="<%= need.getNeedID() %>">
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="item" name="item" placeholder="Item" value="<%= need.getNeedItem() %>">
                    <label for="item">Item</label>
                  </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Quantity" value="<%= need.getNeedQuantity() %>">
                        <label for="quantity">Quantity</label>
                    </div>
                </div>
                <div class="text-center">
                    <a href="volunteer-need.jsp" class="btn btn-secondary">Cancel</a>
