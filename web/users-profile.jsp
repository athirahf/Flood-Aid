              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade emergency-contact pt-3" id="emergency-contact">
                  ...
                  <form action=" " method="POST">
                    ...
                    <div class="row mb-3">
                      <label for="emergencyCName" class="col-md-4 col-lg-3 col-form-label">Full Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input type="text" id="emergencyCName" name="emergencyCName" value="Sarah" class="form-control">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="emergencyCAge" class="col-md-4 col-lg-3 col-form-label">Age</label>
                      <div class="col-md-8 col-lg-9">
                        <input type="number" id="emergencyCAge" name="emergencyCAge" value="50" class="form-control">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="emergencyCNumber" class="col-md-4 col-lg-3 col-form-label">Phone Number</label>
                      <div class="col-md-8 col-lg-9">
                        <input type="text" id="emergencyCNumber" name="emergencyCNumber" value="0173548294" class="form-control">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="emergencyCEmail" class="col-md-4 col-lg-3 col-form-label">Email</label>
                      <div class="col-md-8 col-lg-9">
                        <input type="text" id="emergencyCEmail" name="emergencyCEmail" value="sararah@gmail.com" class="form-control">
                      </div>
                    </div>
                    <button type="submit" class="btn btn-primary">Save Changes</button>
                  </div>
