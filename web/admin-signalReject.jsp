                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="AdminSignalRejectServlet" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="col-lg-10"><input class="form-control" value="<%= shelterr.getShelterID() %>" style="background-color: white;" readonly disabled></input></div>
                                                                          ...
                                                                          <tr>
                                                                              ...
                                                                              <td>
                                                                                  <div style="display: flex; flex-direction: column; align-items: center; gap: 5px;">
                                                                                      <div class="filter">
                                                                                              <button type="button" onclick="window.location.href='admin_signalAction.jsp?SignalID=<%= signal.getSignalID() %>&ShelterID=<%= shelter.getShelterID() %>'" class="btn btn-warning rounded-pill btn-sm ri-bookmark-fill"></button>
                                                                                      </div>
                                                                                  </div>
                                                                              </td>
                                                                          </tr>
                                            ...
                                            <center> 
                                                <div class="btn-group col-lg-6" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#largeModal">Reject</button>
                                                ...
                                                <div class="modal fade" id="largeModal" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              <label for="remarkSelect" class="form-label">Select a reason:</label>
                                                                <select id="remarkSelect" class="form-select" name="remark" onchange="handleRemarkChange()">
                                                                    <option value="False Alarm">False Alarm</option>
                                                                    <option value="Duplicate Report">Duplicate Report</option>
                                                                    <option value="Inaccurate Location">Inaccurate Location</option>
                                                                    <option value="Unclear Information">Unclear Information</option>
                                                                    <option value="Resolved Situation">Resolved Situation</option>
                                                                    <option value="Other">Other (please specify)</option>
                                                                </select>

                                                                <!-- Hidden input field for custom reason -->
                                                                <div id="otherRemarkDiv" class="mt-3" style="display: none;">
                                                                    <label for="otherRemark" class="form-label">Enter your reason:</label>
                                                                    <input type="text" id="otherRemark" name="otherRemark" class="form-control" placeholder="Type your reason here...">
                                                                    <small id="errorText" class="text-danger" style="display: none;">This field cannot be empty</small>
                                                                </div>
                                                            </div>

                                                            <div class="modal-footer">
                                                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                              <button type="submit" class="btn btn-danger" id="confirmReject">Confirm Reject</button>
                                                            </div>
                                                            <script>
                                                                function handleRemarkChange() {
                                                                    let remarkSelect = document.getElementById("remarkSelect");
                                                                    let otherRemarkDiv = document.getElementById("otherRemarkDiv");
                                                                    let otherRemarkInput = document.getElementById("otherRemark");

                                                                    if (remarkSelect.value === "Other") {
                                                                        otherRemarkDiv.style.display = "block";
                                                                        otherRemarkInput.setAttribute("required", "true");
                                                                    } else {
                                                                        otherRemarkDiv.style.display = "none";
                                                                        otherRemarkInput.removeAttribute("required");
